...
export default function TransactionFailure({failureMessage, hash, closeModal} : {failureMessage : string, hash : string, closeModal : () => void}){
    return(
        <div className="flex flex-col w-full gap-y-[5px]">
            <img alt="error icon" className='h-[56px] w-[56px] mt-[12px] self-center' src={errorIcon}/>
            <h3 className="mt-[23px] w-full text-center font-bold text-[22px]">Your transaction has failed.</h3>
